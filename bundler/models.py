...
class Operation(models.Model):
    ...
    callGas = Uint256Field(default=0, validators=[MinValueValidator(0)])
    verificationGas = Uint256Field(default=0, validators=[MinValueValidator(0)])
    ...
    paymaster = EthereumAddressField(default=NULL_ADDRESS)
    paymasterData = HexField(max_length=200000, null=True, blank=True)
